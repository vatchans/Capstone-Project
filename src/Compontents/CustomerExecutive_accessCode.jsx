...
function CustomerExecutive_accessCode() {
  ...
  try{
  let res=await axios.post("https://milk-way-crm.onrender.com/CustomerExcecutive/Autenticate-code",
  {
      code,
   ...
   if(res.status===200){
      ...
      navigate('/CustomerExecutive_NewPassword')
   }
...
export default CustomerExecutive_accessCode