...
function CustomerExecutive_resetPassword() {
    ...
    try{
    let res=await axios.post("https://milk-way-crm.onrender.com/CustomerExcecutive/reset-password",
    {
        Email,
     ...
     if(res.status===200){
        ...
        await localStorage.setItem("CustomerExcecutive_Reset-Password",Email);
        navigate("/CustomerExecutive_Return")
     }
...
export default CustomerExecutive_resetPassword